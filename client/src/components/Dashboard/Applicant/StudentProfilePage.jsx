...
function CreateProfilePage() {
  ...
  const handleHeaderContentChange = (index, field, value) => {
    setFormData((prevData) => {
      const newheaderContent = [...prevData.headerContent];
      newheaderContent[index][field] = value;

      console.log(newheaderContent[0]); // Log the specific entry
      return { ...prevData, headerContent: newheaderContent };
    });
  };
  ...
  return (
    <>
      <form className="space-y-5 min-h-screen relative">
        {/* HEADER */}
          ...
          <span className="headerContent flex w-full gap-8 p-3  pb-4 relative">
            <span className="headerContentLeft w-2/3 space-y-1">
              <h1 className="name text-[20px] font-Poppins font-semibold">
                {formData?.headerContent[0]?.FirstName}{" "}
                {formData?.headerContent[0]?.MiddleName}{" "}
                {formData?.headerContent[0]?.LastName}
              </h1>
              <h1 className="headline text-[15px] font-Poppins font-normal">
                {formData?.headerContent[0]?.Headline}
                {/*
                React Developer | SysAdmin | Networks | Cyber security | IT Support
                 */}
              </h1>
              <h1 className="location text-[13px] font-Poppins pt-2">
                {formData?.headerContent[0]?.Location}
                {/* 
            ...
            <span className="headerContentRight w-1/3 flex flex-col justify-evenly items-center">
              ...
              {formData.ApplicantCV === null ? (
                ...
                <a
                  href={formData?.headerContent[0].ApplicantCV}
                  target="_blank"
                  rel="noreferrer"
            ...
            <button
              ...
              className="w-fit absolute right-3 -top-7 "
            >
              <FaRegEdit className="" size={22} />
            </button>
          </span>
          <Modal
            ...
            <span className="max-w-3xl w-full p-8 flex flex-col gap-4 bg-white rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] font-Poppins">
                ...
                <span className="flex gap-4">
                  <span className="">
                    ...
                    <input
                      ...
                      value={formData?.headerContent[0].FirstName}
                      onChange={(e) =>
                        handleHeaderContentChange(
                          formData.headerContent.length - 1,
                          "FirstName",
                          e.target.value
                        )
                      }
                  ...
                  <span>
                    ...
                    <input
                      ...
                      id="MiddleName"
                      className="mt-1 p-2 w-full border rounded-md"
                      value={formData?.headerContent[0].MiddleName}
                      onChange={(e) =>
                        handleHeaderContentChange(
                          formData.headerContent.length - 1,
                          "MiddleName",
                  ...
                  <span>
                    ...
                    <input
                      ...
                      id="LastName"
                      className="mt-1 p-2 w-full border rounded-md"
                      value={formData?.headerContent[0].LastName}
                      onChange={(e) =>
                        handleHeaderContentChange(
                          formData.headerContent.length - 1,
                          "LastName",
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="Headline"
                  className="mt-1 p-2 w-full border rounded-md"
                  value={formData?.headerContent[0].Headline}
                  onChange={(e) =>
                    handleHeaderContentChange(
                      formData.headerContent.length - 1,
                      "Headline",
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="Location"
                  className="mt-1 p-2 w-full border rounded-md"
                  value={formData?.headerContent[0].Location}
                  onChange={(e) =>
                    handleHeaderContentChange(
                      formData.headerContent.length - 1,
                      "Location",
